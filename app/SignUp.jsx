  ...
  return (
     <SafeAreaView style={tw`flex-1`}>
            ...
            <View style={tw`flex flex-col justify-center items-center gap-6 flex-1 w-full mt-5 px-2`}>
                ...
                />
                <TextInput
                    style={tw`flex text-center text-black-300 w-full bg-blue-100 px-3 py-10 text-lg py-4 text-sm rounded-full`}
                ...
                <View style={tw`flex flex-row items-center justify-center my-2`}>
                    ...
                    <TouchableOpacity onPress={() => router.push('/Login')
                        ...
                        <Text style={tw`text-blue-900 text-blue-800 ml-2 font-bold`}>Login</Text>
                    </TouchableOpacity>
                </View>
